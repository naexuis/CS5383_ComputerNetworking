...
class NetworkTopo (Topo):
    ...
    def build(self, **_opts):
        ...
        self.addLink(router2, router3,
                intfName1='R2-eth3', params1={'ip':'10.0.5.1/24'},
                intfName2='R3-eth2', params2={'ip':'10.0.5.2/24'})
...
def run():
    ...
    # connecting host3 through R2 to R1
    router1.cmd('ip route add 10.0.4.0/24 via 10.0.3.2')
    # connecting host1 through R1 to R2
    router2.cmd('ip route add 10.0.1.0/24 via 10.0.3.1')
    # connecting host2 through R1 to R2
    router2.cmd('ip route add 10.0.2.0/24 via 10.0.3.1')


    router1.cmd('ip route add 10.0.5.0/24 via 10.0.3.2')
    router3.cmd('ip route add 10.0.3.0/24 via 10.0.5.1')
