...
def driver (args):
  ...
  try:
    ...
    while 1 > 0:
      ...
      req.seq_no = 1 # this will be our sequence number
      ...
      order_req.seq_no = 1 # this will be our sequence number
      ...
      end_time = time.time ()
      print ("-----Iteration: {} contents of response message reply_request\n{} ----------".format (1, order_resp.reply_request))
      print ("sending/receiving took {} secs".format (end_time-start_time))
